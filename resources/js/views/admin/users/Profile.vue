                      ...
                      <div class="verification-health-edit">
                        ...
                        >
                          <b-form-select
                            ...
                            v-model="user_verification_result"
                            v-validate="{ required: true }"
                            :state="validateState('verification-input')"
                            aria-describedby="verification-input-live-feedback"
                            data-vv-as="Verification Result"
                            :options="verifications"
                          ></b-form-select>

                          <b-form-invalid-feedback
                            id="verification-input-live-feedback"
                            >{{
                              veeErrors.first("verification-input")
                            }}</b-form-invalid-feedback
                          >
                        </b-form-group> -->
                    ...
                    <ul class="media-list activity-list">
                      ...
                      <li class="media">
                        ...
                        <div class="media-body">
                          <h4 class="media-heading">
                            Adam David
                            <span>just became friends with</span> Shane White
                          </h4>
                ...
                <ul class="media-list activity-list">
                  <li class="media">
                    ...
                    <div class="media-body">
                      ...
                      <small>Today at 3.50pm</small>
                      <p class="mt-2">
                        "When you have children, you always have family. They
                        will always be your priority, your responsibility. And a
                        man, a man provides. And he does it even when he's not
                        appreciated or respected or even loved. He simply bears
                        up and he does it. Because he's a man."
                      </p>
                    </div>
                  </li>
                  <li class="media">
                    ...
                    <div class="media-body">
                      <h4 class="media-heading">
                        Shane White <span>sent a message</span>
                      </h4>
                      <small>Yesterday at 9pm</small>
                      <p class="mt-2">“Hey! How you doin?”</p>
                    </div>
                  </li>
                </ul>
              </tab>
